...
{
    [System.Runtime.InteropServices.Guid("2e3e9432-8652-406b-8480-eb781d4dd042")]
    public class NICartesianOvalDiverge : Command
    {
        static NICartesianOvalDiverge _instance;
        public NICartesianOvalDiverge()
        {
            _instance = this;
        }

        ///<summary>The only instance of the CartesianOvalDiverge command.</summary>
        public static NICartesianOvalDiverge Instance
        {
        ...
        {
            get { return "NICartesianOvalDiverge"; }
        }
        ...
        protected override Result RunCommand(RhinoDoc doc, RunMode mode)
        {
            ...
            List<NI2dPoint> ovalPts = NIUtilities.cartesianOvalDiverge(ptF, n1, ptG, n2, ptP, phi1, phi2, stepsize);
