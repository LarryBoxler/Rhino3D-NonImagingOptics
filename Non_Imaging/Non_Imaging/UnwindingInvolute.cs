...
{
    [System.Runtime.InteropServices.Guid("63635489-e252-4ea8-8973-64d6a0d50bb8")]
    public class NIUnwindingInvolute : Command
    {
        static NIUnwindingInvolute _instance;
        public NIUnwindingInvolute()
        {
            _instance = this;
        }

        ///<summary>The only instance of the NIUnwindingInvolute command.</summary>
        public static NIUnwindingInvolute Instance
        {
        ...
        {
            get { return "NIUnwindingInvolute"; }
        }
        ...
        protected override Result RunCommand(RhinoDoc doc, RunMode mode)
        {
            ...
            List<NI2dPoint> involutePts = NIUtilities.unwindingInvolute(ptP, ptF, radius, phi1, phi2, stepsize);
