...
{
    [System.Runtime.InteropServices.Guid("7013e832-89ac-4b1f-9e6a-375a3ad81657")]
    public class NIWindingMacroEllipse : Command
    {
        static NIWindingMacroEllipse _instance;
        public NIWindingMacroEllipse()
        {
            _instance = this;
        }

        ///<summary>The only instance of the NIWindingMacroEllipse command.</summary>
        public static NIWindingMacroEllipse Instance
        {
        ...
        {
            get { return "NIWindingMacroEllipse"; }
        }
        ...
        protected override Result RunCommand(RhinoDoc doc, RunMode mode)
        {
            ...
            List<NI2dPoint> ellipsePts = NIUtilities.windingmacroEllipse(ptF, radius, ptG, ptP, phi1, phi2, stepsize);
