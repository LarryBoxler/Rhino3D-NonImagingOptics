...
{
    [System.Runtime.InteropServices.Guid("59929261-0fd9-4849-b2c5-93b8b358cedb")]
    public class NIDivergingOvalPtPt : Command
    {
        static NIDivergingOvalPtPt _instance;
        public NIDivergingOvalPtPt()
        {
            _instance = this;
        }

        ///<summary>The only instance of the NIDivergingOvalPtPt command.</summary>
        public static NIDivergingOvalPtPt Instance
        {
        ...
        {
            get { return "NIDivergingOvalPtPt"; }
        }
        ...
        protected override Result RunCommand(RhinoDoc doc, RunMode mode)
        {
            ...
            NI2dPoint ovalPt = NIUtilities.divergingOvalptpt(ptF, n1, v, ptG, n2, S);
