...
{
    [System.Runtime.InteropServices.Guid("535b7be0-6594-42d1-9777-b7c373cd718c")]
    public class NIWindingMacroParabola : Command
    {
        static NIWindingMacroParabola _instance;
        public NIWindingMacroParabola()
        {
            _instance = this;
        }

        ///<summary>The only instance of the NIWindingMacroParabola command.</summary>
        public static NIWindingMacroParabola Instance
        {
        ...
        {
            get { return "NIWindingMacroParabola"; }
        }
        ...
        protected override Result RunCommand(RhinoDoc doc, RunMode mode)
        {
            ...
            List<NI2dPoint> parabPts = NIUtilities.windingmacroParabola(alpha, ptF, radius, ptP, phi1, phi2, stepsize);
